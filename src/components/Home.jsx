...
<div className="nav">
          ...
          <main>
           ...
           {page === "" && <div className="hero-main">
<ModelViewer />
            </div>}
             <>
           {page === "about" && <div className="hero">
              <svg
...
<text x="280" y="340" text-anchor="middle" alignment-baseline="middle" fill="#FFF" fontFamily="RocGroteskWide" font-size="20px"  stroke-width="0.5">
    MINNA
  </text>
                <path
          ...
          data-tooltip-content="Yola"
                ></path>
                <text x="790" y="360" text-anchor="middle" alignment-baseline="middle" fill="#FFF" fontFamily="RocGroteskWide" font-size="20px" stroke-width="0.5">
    YOLA
  </text>
                <path
...
<text x="290" y="600" text-anchor="middle" alignment-baseline="middle" fill="#FFF" fontFamily="RocGroteskWide" font-size="16px" font-weight="700" stroke-width="0.5">
Benin
  </text>
                <path
          ...
          data-tooltip-content="Jos"
                ></path>
                <text x="570" y="410" text-anchor="middle" alignment-baseline="middle" fill="#FFF" fontFamily="RocGroteskWide" font-size="40px" stroke-width="0.5">
    Jos
  </text>
                <path
...
<text x="460" y="450"text-anchor="middle" alignment-baseline="middle" fill="#FFF" fontFamily="RocGroteskWide" font-size="15px" stroke-width="0.5">
Nassarawa
  </text>
                <path
...
<path
          ...
          data-tooltip-content="Kaduna"
                ...
                <text x="430" y="300" text-anchor="middle" alignment-baseline="middle" fill="#FFF" fontFamily="RocGroteskWide" font-size="20px" stroke-width="0.5">
    Kaduna
  </text>
                <path
...
<text x="490" y="200"text-anchor="middle" alignment-baseline="middle" fill="#FFF" fontFamily="RocGroteskWide" font-size="20px" stroke-width="0.5">
Kano
  </text>
...
<text x="387" y="425"text-anchor="middle" alignment-baseline="middle" fill="#FFF" fontFamily="RocGroteskWide" font-size="12px" stroke-width="0.5">
Abuja
  </text>
           ...
           <div className="music_slider">
            ...
            {page === "videos" && <div className="videos" id="videos">
           ...
           {page === "shows" && 
            ...
            <div className="music_slider">
              ...
              <div className="music_inner">
                ...
                <a
                  ...
                  className="slider_item"
                >
                  <img className="music_artwork" src={LagosStreetShow} alt="" />
                  {/* <div className="music_gif">
                    <img src={Genzfuji} alt="" />
                  </div> */}
                ...
                <a
                  ...
                  className="slider_item"
                >
                  <img className="music_artwork" src={AbujaStreetShow} alt="" />
                  {/* <div className="music_gif">
                    <img src={Genzfuji} alt="" />
                  </div> */}
            ...
            {page === "latest release" && <div className="album">
              <div className="album_title">
                LATEST RELEASE:
                <br />
                GEN-Z AREWA
        ...
        <div className="image-grid">
          ...
          {gridImages.map((aspect, index) => (
            ...
            <div
              ...
              style={{
                gridColumn: `span ${hoveredIndex === index ? 
                  Math.min(aspect.cols + 1, 3) : 
                  aspect.cols}`,
                gridRow: `span ${hoveredIndex === index ? 
...
<div className="socials">
  ...
  >
    <defs>
      <linearGradient id="metallicGradient1" gradientTransform="rotate(45)">
        <stop offset="0%" style={{stopColor:"#ffffff", stopOpacity:"0.9"}}/>
        <stop offset="20%" style={{stopColor:"#e0e0e0", stopOpacity:"0.8"}}/>
        <stop offset="50%" style={{stopColor:"#b0b0b0", stopOpacity:"0.9"}}/>
        <stop offset="80%" style={{stopColor:"#e0e0e0", stopOpacity:"0.8"}}/>
  ...
  <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="metallicGradient2" gradientTransform="rotate(45)">
      <stop offset="0%" style={{stopColor:"#ffffff", stopOpacity:"0.9"}}/>
        <stop offset="20%" style={{stopColor:"#e0e0e0", stopOpacity:"0.8"}}/>
        <stop offset="50%" style={{stopColor:"#b0b0b0", stopOpacity:"0.9"}}/>
        <stop offset="80%" style={{stopColor:"#e0e0e0", stopOpacity:"0.8"}}/>
  ...
  >
    <defs>
      <linearGradient id="metallicGradient3" gradientTransform="rotate(45)">
      <stop offset="0%" style={{stopColor:"#ffffff", stopOpacity:"0.9"}}/>
        <stop offset="20%" style={{stopColor:"#e0e0e0", stopOpacity:"0.8"}}/>
        <stop offset="50%" style={{stopColor:"#b0b0b0", stopOpacity:"0.9"}}/>
        <stop offset="80%" style={{stopColor:"#e0e0e0", stopOpacity:"0.8"}}/>
