...
import LogoModelViewer from "../components/LogoModel";
...
import AmandaComponent from "../components/Amanda";
...
<a href="https://x.com/firstklaz_" target="_blank">
     ...
     <Sidebar setPage={setPage} setActive={setActive} active={active} />
      <AmandaComponent />
      {modalOpen && (
